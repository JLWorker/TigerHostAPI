...
public class RestorePasswordDto {
    ...
    public RestorePasswordDto(String email) {
        this.email = email;
    }

    public RestorePasswordDto(String password, String passwordConfirm, String code) {
        this.password = password;
        this.passwordConfirm = passwordConfirm;
        this.code = code;
    }

    public RestorePasswordDto(String password, String passwordConfirm) {
        this.password = password;
        this.passwordConfirm = passwordConfirm;
    }
}
